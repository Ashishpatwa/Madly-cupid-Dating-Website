...
def notification_handler(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        task = PeriodicTask.objects.create(crontab=schedule, name="broadcast-notification-"+str(instance.id), task="broadcast_notification.tasks.broadcast_notification", args=json.dumps((instance.id,)))
